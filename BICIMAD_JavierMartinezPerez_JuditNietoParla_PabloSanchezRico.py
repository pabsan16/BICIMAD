...
def main():
    ...
    with SparkContext() as sc:
        ...
        rdd_winter2019=sort(union(winter2019, sc))
        winter_list2019=rdd_winter2019.collect()
        print("---------------------------WINTER-----------------------------")
        print(winter_list2019)
        
        
        rdd_spring2019=sort(union(spring2019, sc))
        spring_list2019=rdd_spring2019.collect()
        print("---------------------------SPRING-----------------------------")
        print(spring_list2019)
        
        
        rdd_summer2019=sort(union(summer2019, sc))
        summer_list2019=rdd_summer2019.collect()
        print("---------------------------SUMMER-----------------------------")
        print(summer_list2019)
        
        
        rdd_autumn2019=sort(union(autumn2019, sc))
        autumn_list2019=rdd_autumn2019.collect()
        print("---------------------------AUTUMN-----------------------------")
        ...
        rdd_winter2020=sort(union(winter2020, sc))
        winter_list2020=rdd_winter2020.collect()
        print("---------------------------WINTER-----------------------------")
        print(winter_list2020)
        
        
        rdd_spring2020=sort(union(spring2020, sc))
        spring_list2020=rdd_spring2020.collect()
        print("---------------------------SPRING-----------------------------")
        print(spring_list2020)
        
        
        rdd_summer2020=sort(union(summer2020, sc))
        summer_list2020=rdd_summer2020.collect()
        print("---------------------------SUMMER-----------------------------")
        print(summer_list2020)
        
        
        rdd_autumn2020=sort(union(autumn2020, sc))
        autumn_list2020=rdd_autumn2020.collect()
        print("---------------------------AUTUMN-----------------------------")
